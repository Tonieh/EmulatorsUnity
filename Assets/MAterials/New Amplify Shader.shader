...
Shader "Tonieh/Interaction/Simple"
{
	/*CustomNodeUI:HDPBR*/
    Properties
    {
		_MainTex("MainTex", 2D) = "white" {}
		_RimColor("RimColor", Color) = (0,1,0.6777534,0)
		_RimPower("RimPower", Range( 0 , 10)) = 1.545795
		_Float0("Float 0", Float) = 0.54
		[Toggle]_ActiveGrab("ActiveGrab", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
						...
						)
			{
				...
				float fresnelNdotV43 = dot( normalWS, normalizedWorldViewDir );
				float fresnelNode43 = ( 0.0 + _Float0 * pow( 1.0 - fresnelNdotV43, _RimPower ) );
				
				surfaceDescription.Albedo = tex2D( _MainTex, uv_MainTex ).rgb;
				surfaceDescription.Normal = UnpackNormalmapRGorAG( tex2D( _NormalTex, uv_NormalTex ), 1.0f );
				surfaceDescription.Emission = lerp(float4( 0,0,0,0 ),( fresnelNode43 * _RimColor ),_ActiveGrab).rgb;
...
ASEEND*/
//CHKSM=5C6EA612741C8E7A4F8E7DCDB04E31CAAA8ABC95